...
- [x] Operations: 18 runtime tests and one separate Airflow DAG contract test pass. Two real smoke DAG runs produced versions 2 and 3; verified MinIO objects, PostgreSQL metadata, aliases, serving and one shared network. Supplied smoke checker, rollback CLI, Vietnamese runbook and `docs/verification.md`.
